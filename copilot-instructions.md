...
Amzur AI Chat is an internal multi-user conversational AI platform.

**Current Status (Project 2):**
- ✅ User authentication with email/password and JWT tokens
- ✅ PostgreSQL database with SQLAlchemy ORM
- ✅ Chat history persistence and conversation management
...
| Models | `gpt-4o`, `gemini-2.5-flash` (via proxy) |
...
│   │   │   ├── useAuthenticatedChat.ts  # Chat hook with auth
